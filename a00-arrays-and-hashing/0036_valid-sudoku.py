...
class Solution:
    def initial_isValidSudoku(self, board: list[list[str]]) -> bool:
    ...
    def cleaner_isValidSudoku(self, board: list[list[str]]) -> bool:
...
if __name__ == "__main__":
    ...
    run_tests(
        test_cases,
        [
            solution.initial_isValidSudoku,
            solution.cleaner_isValidSudoku
        ],
        label=__file__
    )
